...
<head>
    ...
    <link href='<c:url value="/css/styleSearch.css"/>' rel="stylesheet" type="text/css">
</head>
...
<form action="${pageContext.request.contextPath}/recipes" method="post">
    <section class="mr-4 ml-4">
        <div class="search">
            ...
            <label for="hd-1"><h1>Kliknij tutaj, aby wyszukać przepis.</h1></label>
            <div>
                <table class="table">
                    <thead>
                    <tr class="d-flex text-color-darker">
                        <th scope="col" class="col-6">Wpisz nazwę przepisy</th>
        ...
        <table class="table">
            ...
            <c:forEach var="recipe" items="${requestScope.recipes}">
                <tr class="d-flex">
                    ...
                    <td class="col-1"><a href="#" class="btn btn-info rounded-4 text-light">Szczegóły</a></td>
                </tr>
            </c:forEach>
